...
const GamepadComponent = () => {
  ...
  const getButtonFill = (buttonName) => {
    return buttonStates[buttonName] ? 'rgba(255, 255, 255, 1)' : 'rgba(0,0,0,0)';
  };

  const getAxisPosition = (axisXName, axisYName, centerX, centerY, radius) => {
    const x = centerX + (axisStates[axisXName] || 0) * radius;
    const y = centerY + (axisStates[axisYName] || 0) * radius;
    return { x, y };
  };
  ...
  const renderedGamepad = React.useMemo(() => {
    ...
    return (
      <div className="mb-6 rounded text-white">
        {/* SVG Controller */}
        <div className="mt-4">
            <svg
                    width="450"
                    ...
                    <g id="XBox">
                      ...
                      <g id="BLeft">
                        ...
                        <path
                          ...
                          fill={getButtonFill('button2')}
                          stroke="rgba(255,255,255,1)"
                          strokeWidth="6"
                          mask="url(#path-16-inside-8)"
                        />
                      </g>
                      {/* Left Meta Button (Button 8 - Select) */}
                      <g id="LMeta">
                        <circle
                          cx="185"
                          cy="162"
                          r="10"
                          fill={getButtonFill('button8')}
                          stroke="rgba(255,255,255,1)"
                          strokeWidth="3"
                        />
                      </g>
                      {/* Right Meta Button (Button 9 - Start) */}
                      <g id="RMeta">
                        <circle
                          cx="259"
                          cy="162"
                          r="10"
                          fill={getButtonFill('button9')}
                          stroke="rgba(255,255,255,1)"
                          strokeWidth="3"
                        />
                      </g>
