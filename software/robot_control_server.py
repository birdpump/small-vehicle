...
def move_robot(linear_velocity, angular_velocity):
    ...
    if angular_velocity > threshold:
        ...
        right_wheel_speed = abs(right_wheel_speed)*abs(angular_velocity-angular_velocity)  #keep right wheel forward
    elif angular_velocity < -threshold:
        left_wheel_speed = abs(left_wheel_speed)*abs(angular_velocity-angular_velocity)  #keep left wheel forward
